...
@section('cms_content')
<h1 class="page-header">Here you can add new author</h1>
<div class="row">
      <div class="col-md-6">
        <form action="{{ url('cms/authors') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="form-group">
                <label for="InputTitle">Title:</label>
                <input value="{{ old('title') }}" type="text" name="title" class="form-control original-text-input" id="InputTitle" placeholder="Author name">
            </div>
            ...
            <div class="form-group">
                <label for="InputImage">Author image:</label>
